...
<div class="flex min-h-screen bg-slate-50">
    <aside class="w-64 bg-emerald-900 text-white hidden lg:flex flex-col shrink-0 font-sans">
        <div class="p-6 text-2xl font-black tracking-tighter text-white">
            FOOD<span class="text-emerald-400">FUSION</span>
        </div>
        <nav class="flex-grow mt-4">
            ...
            <a href="manage_community.php" class="block px-6 py-4 bg-emerald-800 border-l-4 border-emerald-400 font-bold">Cookbook Management</a>
