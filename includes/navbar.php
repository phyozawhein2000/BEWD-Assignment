...
<div class="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-stone-100 z-[100] px-4 pb-6 pt-3 flex justify-around items-center shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
    <a href="index.php" class="flex flex-col items-center transition-all <?php echo ($current_page == 'index.php') ? 'text-emerald-800' : 'text-stone-400'; ?>">
    ...
    <a href="recipes.php" class="flex flex-col items-center transition-all <?php echo ($current_page == 'recipes.php') ? 'text-emerald-800' : 'text-stone-400'; ?>">
    ...
    <a href="community.php" class="flex flex-col items-center transition-all <?php echo ($current_page == 'community.php') ? 'text-emerald-800' : 'text-stone-400'; ?>">
    ...
    <a href="<?php echo isset($_SESSION['user_id']) ? 'dashboard.php' : 'auth/login.php'; ?>" class="flex flex-col items-center transition-all <?php echo ($current_page == 'dashboard.php') ? 'text-emerald-800' : 'text-stone-400'; ?>">
...
<nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-stone-100">
    <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8 text-[13px] font-bold tracking-widest uppercase">
            <a href="index.php" class="<?php echo ($current_page == 'index.php') ? 'text-emerald-800' : 'text-stone-500 hover:text-emerald-800'; ?> transition">Home</a>
            <a href="recipes.php" class="<?php echo ($current_page == 'recipes.php') ? 'text-emerald-800' : 'text-stone-500 hover:text-emerald-800'; ?> transition">Recipes</a>
            <a href="community.php" class="<?php echo ($current_page == 'community.php') ? 'text-emerald-800' : 'text-stone-500 hover:text-emerald-800'; ?> transition">Community</a>
            ...
            <a href="aboutus.php" class="<?php echo ($current_page == 'aboutus.php') ? 'text-emerald-800' : 'text-stone-500 hover:text-emerald-800'; ?> transition">About Us</a>
            <a href="contact.php" class="<?php echo ($current_page == 'contact.php') ? 'text-emerald-800' : 'text-stone-500 hover:text-emerald-800'; ?> transition">Contact Us</a>
        </div>
                ...
                <div class="flex items-center space-x-4 border-r pr-6 border-stone-200">
                    ...
                    <?php if(isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                        <a href="admin/index.php" class="bg-amber-100 text-amber-700 p-2 rounded-xl hover:bg-amber-200 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1。533 0 01.947-2。２８７c１。５６１－．３７９ １。５６１－２。６ ０－２。９７８a１。５３２ １。５３２ ０ ０１－．９４７－２。２８７c．８３６－１。３７２－．７３４－２。９４２－２。１０６－２。１０６a１。５３２ １。５３２ ０ ０１－２。２８７－．９４７zM１０ １３a３ ３ ０ １００－６ ３ ３ ０ ０００６z" clip-rule="evenodd" /></svg>
                        </a>
                    <?php endif; ?>
                </div>
...
<aside id="mobileSidebar" class="fixed inset-y-0 right-0 w-[85%] max-w-xs bg-white z-[120] translate-x-full transition-transform duration-300 ease-in-out md:hidden shadow-2xl overflow-y-auto">
    <div class="p-8 flex flex-col h-full">
        <div class="flex justify-between items-center mb-10">
            <span class="text-[10px] font-black text-stone-300 uppercase tracking-[0.2em]">Menu</span>
            <button onclick="toggleMobileSidebar()" class="p-2 bg-stone-100 rounded-full text-stone-500">
        ...
        <nav class="space-y-1">
            <div class="relative">
                <button onclick="toggleMobileDropdown()" class="w-full flex items-center justify-between p-4 rounded-2xl hover:bg-emerald-50 text-stone-700 font-bold transition-all">
                    <div class="flex items-center space-x-4">
                        <span class="bg-stone-100 p-2 rounded-xl">📚</span>
                        <span>Resources</span>
                    </div>
                ...
                <div id="mobile-resources-menu" class="hidden overflow-hidden bg-stone-50/50 rounded-2xl mx-2 mt-1 transition-all">
                    <a href="culinary_resources.php" class="block p-4 pl-12 hover:text-emerald-800 text-stone-600 font-bold text-sm">Culinary Resources</a>
                    <a href="educational_resources.php" class="block p-4 pl-12 hover:text-emerald-800 text-stone-600 font-bold text-sm">Educational Resources</a>
                </div>
            </div>
            <a href="aboutus.php" class="flex items-center space-x-4 p-4 rounded-2xl hover:bg-emerald-50 text-stone-700 font-bold transition-all">
                <span class="bg-stone-100 p-2 rounded-xl">👋</span>
                <span>About Us</span>
            </a>
            <a href="contact.php" class="flex items-center space-x-4 p-4 rounded-2xl hover:bg-emerald-50 text-stone-700 font-bold transition-all">
                <span class="bg-stone-100 p-2 rounded-xl">📧</span>
                <span>Contact</span>
            </a>
        </nav>
        ...
        <div class="mt-auto pt-8 border-t border-stone-100">
            ...
            <?php else: ?>
                <button onclick="toggleMobileSidebar(); openModal();" class="w-full bg-emerald-800 text-white text-center py-4 rounded-2xl font-bold shadow-lg mb-3">Sign Up Free</button>
                <a href="auth/login.php" class="block w-full text-center py-3 text-stone-500 font-bold">Sign In</a>
            <?php endif; ?>
        </div>
    </div>
</aside>
...
<script>
    ...
    // AJAX Form Submission remains the same...
